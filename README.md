...
* 3、支持dump-goroutine-stack-traces
  ...
  github.com/guyuxiang/gin-apiserver/pkg/util.dumpStacks()
          /root/go/src/github.com/guyuxiang/gin-apiserver/pkg/util/trap.go:23 +0x6d
  github.com/guyuxiang/gin-apiserver/pkg/util.SetupSigusr1Trap.func1(0xc000332240)
          /root/go/src/github.com/guyuxiang/gin-apiserver/pkg/util/trap.go:16 +0x34
  created by github.com/guyuxiang/gin-apiserver/pkg/util.SetupSigusr1Trap
          /root/go/src/github.com/guyuxiang/gin-apiserver/pkg/util/trap.go:14 +0xab
  ...
  github.com/gin-gonic/gin.(*Engine).Run(0xc000394000, 0xc000355f48, 0x1, 0x1, 0x0, 0x0)
          /root/go/src/github.com/guyuxiang/gin-apiserver/vendor/github.com/gin-gonic/gin/gin.go:294 +0x140
  main.main()
          /root/go/src/github.com/guyuxiang/gin-apiserver/cmd/main.go:22 +0x2c4
...
* step3 - 启动服务  
  ...
  $ docker tag guyuxiang/gin-apiserver:v0.1.0 xxx/guyuxiang/gin-apiserver:v0.1.0
  $ docker push xxx/guyuxiang/gin-apiserver:v0.1.0
  # Update the deployment to use the built image name
  $ sed -i 's|REPLACE_IMAGE|xxx/guyuxiang/gin-apiserver:v0.1.0|g' hack/deploy/deployment.yaml
  # create service 
